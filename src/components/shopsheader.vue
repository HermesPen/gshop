<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showShopDetail = !showShopDetail">
    ...
    >
      <div class="discounts-left">
        <div class="activity" :class="changeClasses[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showShopDetail">
        <div class="brief-modal-content">
          ...
          <div class="brief-modal-notice">
            是以粥为特色的中式营养快餐，自 2004 年 10 月 18
            日创立“嘉和一品”品牌至今
          </div>
          <div class="mask-footer">
            <span
              class="iconfont icon-close"
              @click="showShopDetail = !showShopDetail"
            ></span>
          </div>
        </div>
    ...
    <div class="activity-sheet" v-show="showSupports">
      <div class="activity-sheet-content">
        ...
        <ul class="list" v-for="(support, index) in info.supports" :key="index">
          <li class="activity-item" :class="changeClasses[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="showSupports = !showSupports">
...
export default {
  data() {
    return {
      changeClasses: ["activity-green", "activity-orange", "activity-red"],
