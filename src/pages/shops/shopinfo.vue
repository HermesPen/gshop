        ...
        <div class="activity">
          <div class="activity-item activity-green">
            ...
            <span class="activity-content"
              >新用户下单立减 17 元(不与其它活动同享)</span
            >
          </div>
          <div
            class="activity-item"
            :class="changeClasses[support.type]"
...
export default {
  ...
  methods: {
    _initScroll() {
      ...
      // 计算ul盒子的宽度
      const ul = document.querySelector(".pic-list");
      const imgs = this.info.pics.length;
      ul.style.width = (120 + 6) * imgs - 6 + "px";
